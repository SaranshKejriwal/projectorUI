...
#get kinect input__________________________________________________________________________
	...
	for i in contours:
		...
		cv2.circle(ui, (x,y), 3, (185, 25, 25), 5)#brush
		#cv2.imwrite("ui_paint.jpg",ui)#write back painting to UI in each frame, to be re-read
		#imwriting frame allows us to make crosshair, else it'll be painted everywhere		
	...
	'''cv2.circle(ui, (x,y), 4, (0, 0, 0), 2)# I hope this has no trail
